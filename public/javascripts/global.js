...
function populateTable() {
    ...
    $.getJSON( '/users/userlist', function( data ) {
        ...
        $.each(data, function(){
			...
			tableContent += '<td>' + this.contribuicao + '</td>';
...
function showUserInfo(event) {
	...
	$('#userInfoTelefone').text(thisUserObject.telefone);
	$('#userInfoContribuicao').text(thisUserObject.contribuicao);
...
function addUser(event) {
    ...
    if(errorCount === 0) {
        ...
        var usuario = {
            ...
            'telefone': $('#addUser fieldset input#inputUserTelefone').val(),            
			'contribuicao': $('#addUser fieldset input#inputUserContribuicao').val()
        }
